...
export enum BooksTypes {
  ...
  SORT_BY_TITLE_REQUEST = '@books/SORT_BY_TITLE_REQUEST',
  SORT_BY_TITLE_SUCCESS = '@books/SORT_BY_TITLE_SUCCESS',
  SORT_BY_DATE_REQUEST = '@books/SORT_BY_DATE_REQUEST',
  SORT_BY_DATE_SUCCESS = '@books/SORT_BY_DATE_SUCCESS',
}
